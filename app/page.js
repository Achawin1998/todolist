  ...
  return (
    <section className="flex justify-center ">
      <div className="text-center  w-full ">
        <h1 className="my-3 text-4xl text-gray-800 font-semibold">
          Note Todo For Today
        </h1>
        ...
        <div className=" container mx-auto">
          <div className=" flex flex-col items-center ">
            ...
            {items.length > 0 && (
              <h2 className="mt-8 mb-3 text-gray-800 text-3xl font-semibold ">
                Your Note List (
                <span className="text-rose-700 text-3xl hover:text-sky-500 cursor-pointer">
                  {itemsCount}
                </span>
                <span> ) </span>
              </h2>
              ...
              {items.map((item) =>
                item.isEdit ? (
                  <Edit
                    ...
                    toggleChangeToEdit={toggleChangeToEdit}
                  />
                ) : (
                  <Items
                    key={item.id}
